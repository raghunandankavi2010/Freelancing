...
public class MyAccount extends TabActivity implements OnClickListener{
	 @Override
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        thirdTabSpec.setIndicator("Transfer Funds", getResources().getDrawable(R.drawable.mtransfer)).setContent(new Intent("idss.bank.demo.FundTransfer"));
	        forthTabSpec.setIndicator("Locate Us", getResources().getDrawable(R.drawable.locate)).setContent(new Intent("idss.bank.demo.Location"));
