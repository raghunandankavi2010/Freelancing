...
if("IRS".equals(datarate))
 ...
 jTextArea1.setText(all);                        
                            ...
                            while( j<a.size())
  {
                                ...
                                System.out.println("Valu is"+Integer.parseInt(a.get(j)));
                                jComboBox1.addItem(Integer.parseInt(a.get(j+1)));
                        jComboBox1.setSelectedIndex(k);
                        jSpinner2.setValue(Integer.parseInt(a.get(j+2)));
                        jTextField1.setText(a.get(j+3));
                        jTextField2.setText(a.get(j+4));
                        
                            try { 
                                Thread.sleep(100);
                                jTable1.setValueAt(j, 4, 4);
                                //System.out.println("First Value set");
                                //System.out.println("Setting Second value");
                                j=j+5;
                                k=k+1;
                        ...
                        { jSpinner1.setValue(Integer.parseInt(words[i]));
                        jComboBox1.addItem(Integer.parseInt(words[i+1]));
                       // jComboBox1.setSelectedItem(10);
                        jSpinner2.setValue(Integer.parseInt(words[i+2]));
                        jTextField1.setText(words[i+3]);
                        jTextField2.setText(words[i+4]);
                        }*/
                    } catch (IOException ex) {
                    }
