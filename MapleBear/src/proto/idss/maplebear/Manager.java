...
public class Manager extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        loadImages();
        setContentView(R.layout.memgame);
       
        TextView url = ((TextView)findViewById(R.id.myWebSite));
        Linkify.addLinks(url, Linkify.WEB_URLS);
        
        Button abtButton = (Button)findViewById(R.id.button1);
        abtButton.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				startActivity(new Intent("proto.idss.maplebear.HowToPlay"));
			}
		});
    ...
    private void newGame(int c, int r) {
    	...
    	tr.removeAllViews();
    	TableRow tr2 = ((TableRow)findViewById(R.id.TableRow06));
    	tr2.removeAllViews();
